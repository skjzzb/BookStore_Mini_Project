				...
				<table>
						...
						<!--tr>
				 	 	...
				 	 	<tr>
							<td><h3>Date *:</h3></td>
							<td><br>
						<br><input class="form-control" type="text" name="date" value="YYYY-MM-DD" required><br>
						<br></td>
				 	 	</tr>
						<br>
						<br>
						...
						<input type="hidden" name="uid" value="<%= uid %>">
 						<td><Button class="btn btn-info1 btn-rounded" Type="submit" formaction="ohisuser2.jsp">Submit</Button></td> 
  						<td></td>
  						</tr>
